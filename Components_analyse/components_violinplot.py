...
# Chemins
# BLAST
COMP_FILE = "/tempory/21234701/blast_components.tsv"   # Fichier contenant les composantes

# BLAST & Embeddings
# Ils ont les mêmes composantes donc on peut tester sur un seul fichier
ALPHA_COMP_FILE = "/tempory/21234701/components_combined_graph_alpha_0.2.tsv"
...
plt.savefig("./Images/blast_components.png", bbox_inches="tight", dpi=300)
plt.show()