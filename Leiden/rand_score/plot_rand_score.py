...
for gamma_col in gamma_cols:
    ...
    plt.plot(alpha_values, gamma_scores, marker="o", linewidth=2, markersize=8, label=gamma_label)

plt.xlabel("Valeurs de alpha", fontsize=12)
plt.ylabel("Rand Score (moyenne)", fontsize=12)
plt.title("Rand score en fonction des valeurs de alpha et gamma - Leiden", fontsize=14, fontweight="bold")
plt.grid(True, alpha=0.3)
plt.legend()
plt.savefig("./Images/rand_score.png", bbox_inches="tight")
plt.show()